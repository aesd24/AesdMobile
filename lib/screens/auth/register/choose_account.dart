      ...
      Align(
          ...
          child: Padding(
              ...
              child: Column(
                  ...
                  children: List.generate(Type.accountTypes.length, (value) {
                    var account = Type.accountTypes[value];
  ...
  return GestureDetector(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => RegisterPage(accountType: value)));
      },
      child: Container(
          ...
          child: ListTile(
              ...
              trailing: Container(
                ...
                child:
                    const Icon(Icons.keyboard_arrow_right, color: Colors.green),
              ))));
}
