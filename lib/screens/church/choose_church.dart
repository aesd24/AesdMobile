...
class _ChooseChurchState extends State<ChooseChurch> {
          ...
          content: const Column(
            ...
            children: [
              Padding(
                ...
                child: Text("Une demande de validation sera envoyé au serviteur principale."),
              ),
              Padding(
                padding: EdgeInsets.symmetric(vertical: 5),
                child: Text("En attendant la réponse, vous profiterez de l'application en tant que fidèle."),
              ),
              Padding(
                padding: EdgeInsets.symmetric(vertical: 5),
  ...
  Future loadChurches() async {
    ...
    try {
      ...
      messageBox(
        ...
        content: const Column(
          children: [
            Text("Impossible de récupérer la liste des églises."),
            Text("Vérifiez votre connexion internet et rééssayez !")
          ],
        ),
        actions: [
          TextButton(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Choisir une église")
      ),
      body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              customButton(
                ...
                trailing: const Icon(Icons.church_outlined, color: Colors.white),
                onPressed: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => CreateChurchPage())
                  );
                }
              ),
                  ...
                  child: Builder(
                    builder: (context) {
                      if(churchList == null){
                        ...
                        return churchList!.isNotEmpty ? ListView(
                          children: List.generate(getList().length, (value){
                            if (getList().isNotEmpty){
                              ...
                              return churchSelectionTile(
                                ...
                                id: church.id!,
                                name: church.name,
                                mainPastor: church.mainServant != null ? church.mainServant!.name : "inconnu",
                                zone: church.address,
                              ...
                              return Container(
                                ...
                                child: const Column(
                                  ...
                                  children: [
                                    ...
                                    Text("Aucune résultat correspondant à la recherche !")
                                  ],
                                ),
                              );
                            }
                          ...
                          child: Container(
                            ...
                            child: const Column(
                              ...
                              children: [
                                Icon(Icons.search_off, size: 60),
                                Text("Aucune église disponible pour le moment !")
                              ],
                            ),
                          ),
                        );
