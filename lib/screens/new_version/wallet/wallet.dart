...
import 'package:aesd_app/screens/new_version/wallet/send.dart';
import 'package:aesd_app/screens/new_version/wallet/transactions.dart';
import 'package:aesd_app/screens/new_version/wallet/withdrawing.dart';
                  ...
                  child: Row(
                    ...
                    children: [
                      customTransactionButton(
                          ...
                          onTap: () =>
                              pushForm(context, destination: const SendPage())),
                      customTransactionButton(
                          title: "Retirer",
                          icon: Image.asset("assets/images/Recieve.png",
                              scale: 2.5),
                          backColor: themeColors.primary,
