...
import 'package:aesd_app/screens/new_version/notifications/notifications.dart';
  ...
  init() async {
    try {
      ...
      messageBox(
        ...
        isDismissable: false,
        content: const Text(
            "Impossible de récupérer les informations personnels. Veuillez vous reconnecter."),
