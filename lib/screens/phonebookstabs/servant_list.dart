...
import 'package:aesd_app/screens/servant_show.dart';
import 'package:aesd_app/utils/constants.dart';
import 'package:aesd_app/widgets/servant_list_item.dart';
...
class ServantList extends StatefulWidget {
  ...
  @override
  _ServantListState createState() => _ServantListState();
}

class _ServantListState extends State<ServantList> {
  final PagingController<int, ServantModel> _pagingController =
  ...
  Future<void> _fetchPage(int pageKey) async {
    try {
      final newPage = await Provider.of<Servant>(context, listen: false)
    ...
    return RefreshIndicator(
      ...
      child: Padding(
        ...
        child: PagedListView.separated(
          ...
          builderDelegate: PagedChildBuilderDelegate<ServantModel>(
            itemBuilder: (BuildContext context, servant, index) =>
                ServantListItem(
              servant: servant,
              onPress: () => {
                Navigator.push(
